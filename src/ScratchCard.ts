...
export class ScratchCard extends LitElement {
	...
	private content: Ref<HTMLDivElement> = createRef();
	...
	refreshCanvas(): void {
		...
		if (this.coverSrc) {
			...
			cover.onload = () => {
				const [dWidth, dHeight] = this.scaleCover
